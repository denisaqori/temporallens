...
| **Repetition policy** — DB2 has 6 repetitions per movement per subject; the word appears nowhere in specs or configs. Needed for D5 especially: which repetitions supply the k calibration examples vs. the evaluation windows, or the adaptation baseline leaks | Claude (gap analysis) | 2026-07-29 | Blocks the split manifest (D6). Open question, not a proposal. |
